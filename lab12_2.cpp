...
int main(){	
	...
	if(playerAction == 1){
		...
		cout << "Your 3rd card: " << cardNames[pcard] << "\n";
		cout << "Your new score: " << calScore(playerScore,pcard,0) << "\n";
		playerScore = calScore(playerScore,pcard,0);
	}
	cout << "------------ Turn end -------------------\n\n";
	...
	if(yugiAction == 1){
		...
		cout << "Yugi's 3rd card: " << cardNames[ycard] << "\n";
		cout << "Yugi's new score: " << calScore(yugiScore,ycard,0) << "\n";
		yugiScore = calScore(yugiScore,ycard,0);
	}
	cout << "------------ Turn end -------------------\n";
